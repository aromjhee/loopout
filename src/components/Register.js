      ...
      <div className='w-5/6 flex justify-center'>
        <form className='w-5/6 text-4xl'>
          ...
          <div className='md:flex md:items-center mb-24'>
            ...
            <div className='md:w-2/3'>
              <input className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500' id='repassword' type='password' placeholder='*********' autoComplete='on' value={password} onChange={(e) => setRePassword(e.target.value)} />
            </div>
          </div>
